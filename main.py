...
mongo_atlas_user_name = st.secrets["mongo_atlas_user_name"]  #os.getenv("mongo_atlas_user_name") 
mongo_atlas_password =  st.secrets["mongo_atlas_password"]  #os.getenv("mongo_atlas_password")
...
def load_generative_model():
    genai.configure(api_key=st.secrets["google_genai_api_key"])  #os.getenv("google_genai_api_key")
    generation_config = {
        "temperature": 1,
        "top_p": 0.95,
        "top_k": 64,
